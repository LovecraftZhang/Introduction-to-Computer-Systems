...
void list_map2 (void (*f) (element_t*, element_t, element_t), struct list* out_list, struct list* in_list0, struct list* in_list1) {
  // TODO
	int mim_len = (in_list0->len < in_list1->len)? in_list0->len : in_list1->len;
	for (int i = 0; i < mim_len; i++){
		element_t out = 0;
 ...
 */
void intptr_t (void (*f) (element_t*, element_t, element_t), element_t* out_element_p,  struct list* in_list) {
  // TODO
	for (int i = 0; i < in_list->len; i++) {
