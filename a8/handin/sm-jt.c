...
int exec() {
  ...
  static const void* jumptable[16] = {&&LO, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7. &&L8, &&L9, &&LA, &&LB, &&LC, &&LD, &&LE, &&LF};
  static const void* ALU_jumptable[9] = {&&ALU0, &&ALU1, &&ALU2, &&ALU3, &&ALU4, &&ALU5, &&ALU6, &&ALU7, &&ALUF};
...
LD: // j *o(rr) .............. droo
        // TODO
        addr = reg[insOp0] + (((unsigned short) insOpImm) << 2);
