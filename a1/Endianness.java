...
public class Endianness {
  ...
  public static int bigEndianValue (Byte[] mem){
        ...
        i = (mem[0] & 0x000000ff) << 24;
        j = (mem[1] & 0x000000ff) << 16;
        m = (mem[2] & 0x000000ff) << 8;
        
        return i + j + m + (mem[3] & 0x000000ff);
    }
  
  public static int littleEndianValue (Byte[] mem){
        int i,j,m,n;
        
        i = (mem[3] & 0x000000ff) << 24;
        j = (mem[2] & 0x000000ff) << 16;
        m = (mem[1] & 0x000000ff) << 8;
        
        return i + j + m + (mem[0] & 0x000000ff);
    }
